<div id="addf_client" class="modal fade" aria-labelledby="addTherapist">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="f_clientsForm" action="{{ URL::to('f_client/store') }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="form-row">
						...
						<div class="form-group col-md-12 col-xs-12">
							<div class="clearfix text-right mt-3">
								<button type="submit" id="f_clientsFormBtn" class="btn btn-success">
									Add Client
								</button>
							</div>
						</div>
