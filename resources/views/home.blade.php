                                                ...
                                                <div class="col-3 {{ $dragclass }}">
                                                    <div class="card-box {{ $room }}" title="Job Order#:{{ $r->job_order}}<br/>Therapist:{{ $r->therapistname }}<br/>Service:{{ $service }}">
                                                        ...
                                                        @if($r->status == 'Active')
                                                            ...
                                                            <a id="job_order_print" class="header-title float-right" onclick="javascript:jsWebClientPrint.print('id={!! $r->job_order !!}&useDefaultPrinter=checked&printerName=Epson Tm-t8211')""><i class="mdi mdi-printer"></i></a>
                                            ...
                                            @foreach($lounge as $r)
                                                ...
                                                <div class="col-3 {{ $dragclass }}">
                                                    <div class="card-box {{ $room }}" title="Job Order#:{{ $r->job_order}}<br/>Therapist:{{ $r->therapistname }}<br/>Service:{{ $service }}">
                                                        ...
                                                        @if($r->status == 'Active')
                                                            <p class="header-title float-left">{{ $r->roomname}}</p>
                                                            <a class="header-title float-right" onclick="javascript:jsWebClientPrint.print('id={!! $r->job_order !!}&useDefaultPrinter=checked&printerName=Epson Tm-t8211')""><i class="mdi mdi-printer"></i></a>
